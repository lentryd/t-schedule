...
/**
 * Отправляет инструкцию по добавлению календаря в Apple iCalendar.
 * @param ctx Контекст callback
 * @returns Promise<void>
 */
export default async function callbackICal(ctx: CallbackContext): Promise<void> {
    ...
    return await ctx
        .replyWithVideo('https://drive.google.com/uc?id=1IXNCIeRYVuL624KDmE2wLOFsKPOUTb_Z&export=download', {
            caption: fmt`
          ${bold(
